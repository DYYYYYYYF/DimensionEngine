...
bool VulkanMaterialShader::AcquireResources(VulkanContext* context, uint32_t* id) {
	// TODO: free list
...
void VulkanMaterialShader::ReleaseResources(VulkanContext* context, uint32_t id) {
