...
def delete_files(folder_path, exclude_files=None, recursive=False):
    ...
    if exclude_files is None:
        exclude_files = ['Material.dmt', 'Material.UI.dmt', 'Material.Builtin.Text.dmt', 'Material.Builtin.Skybox.dmt', 'Material.Builtin.GBuffer.dmt', 'Material.Builtin.DeferredLighting.dmt']
